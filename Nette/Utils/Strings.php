...
class Strings
{
	...
	{
		return self::call('preg_split', array($pattern, $subject, -1, $flags | PREG_SPLIT_DELIM_CAPTURE));
	}
	...
	public static function match($subject, $pattern, $flags = 0, $offset = 0)
	{
		...
		return self::call('preg_match', array($pattern, $subject, & $m, $flags, $offset))
			? $m
			: NULL;
	}
	...
	public static function matchAll($subject, $pattern, $flags = 0, $offset = 0)
	{
		...
		self::call('preg_match_all', array(
			$pattern, $subject, & $m,
	...
	public static function replace($subject, $pattern, $replacement = NULL, $limit = -1)
	{
		if (is_object($replacement) || is_array($replacement)) {
			...
			return self::call('preg_replace_callback', array($pattern, $replacement, $subject, $limit));
		...
		return self::call('preg_replace', array($pattern, $replacement, $subject, $limit));
	}
